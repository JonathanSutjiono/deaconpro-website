...
export const fallbackHomepage: HomepageContent = {
  ...
  heroImageAlt: "Construction and interior work by Deacon Pro",
  primaryButtonLabel: "Consult on WhatsApp",
  ...
  servicesSubtitle: `Construction, interior fit-out, renovation, and home maintenance across ${company.serviceArea}.`,
